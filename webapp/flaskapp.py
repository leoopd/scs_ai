...
@app.route('/scsai')
def page():
    return render_template('/home/code-server/code-server-app/python/webapp/flaskapp/ai_template.html')
...
def scs_ai():
    ...
    return render_template('/home/code-server/code-server-app/python/webapp/flaskapp/ai_template.html', output=ai_output)
